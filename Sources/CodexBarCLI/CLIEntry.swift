...
enum CodexBarCLI {
    static func main() async {
        ...
        do {
            ...
            case ["cards"], ["usage"]:
                // Fork: cards --watch enters the interactive TUI, which owns its own
                // signal handling — bypass runUsageDisplay's termination monitor.
                if invocation.path == ["cards"], invocation.parsedValues.flags.contains("watch") {
